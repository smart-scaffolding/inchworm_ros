...
def spawn_node(
            islandNamespace=None, namespace=None, island_id=None, robot_id=None,
            model_location=None, camera_location=None, robot_name=None,
            camera_en=False
        ):
    ...
    arg_model = "-param robot_description -urdf -model {}_{}_{} -x {} -y {} -z {}".format(
            robot_name, island_id, robot_id, model_location[0], model_location[1], model_location[2])
    # print(arg_model + ": ARG MODEL")

    arg_camera = ""
    if camera_en:
        arg_camera = "-urdf -param camera -model camera_{}_{} -x {} -y {} -z {} ".format(
            island_id, robot_id, (camera_location[0]), (camera_location[1] - 1), (camera_location[2]))
...
def spawn():
    """ Launch simulation with Gazebo """
    node_spawns = spawn_node(namespace="/robot_model/",
                             robot_id=1, robot_name="robot_model")
